...
module.exports = function(grunt) {
	...
	grunt.registerTask('default', ['jshint', 'test_orig', 'clean:build', 'concat', 'uglify', 'createunit:qunit_dist',
		'qunit:dist', 'createunit:qunit_min', 'qunit:min', 'jsdoc'
	]);

	grunt.registerTask('test_orig', ['jshint:test', 'clean:test_orig', 'createunit:nodeunit_orig', 'nodeunit:orig',
		'createunit:qunit_orig', 'qunit:orig'
	]);
	grunt.registerTask('test_dist', ['jshint:test', 'clean:test_dist', 'createunit:nodeunit_dist', 'nodeunit:dist',
		'createunit:qunit_dist', 'qunit:dist'
	]);
	grunt.registerTask('test_min', ['jshint:test', 'clean:test_min', 'createunit:nodeunit_min', 'nodeunit:min',
		'createunit:qunit_min', 'qunit:min'
	]);
